class UserActivitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_activity.save
        format.html { redirect_to user_user_activity_path(@user_activity.user_id,@user_activity.id), notice: 'User activity was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_user_activities_url, notice: 'User activity was successfully destroyed.' }
